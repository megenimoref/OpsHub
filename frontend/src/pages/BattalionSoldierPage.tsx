          ...
          <div className="bg-gray-900 border border-gray-700 rounded-2xl p-6 w-full max-w-md shadow-2xl" onClick={(e) => e.stopPropagation()}>
            ...
            {user?.phone && (
              <p className="text-xs text-gray-500 mb-3">
                יתווסף אוטומטית: <span className="text-gray-400">לפרטים נוספים או לעזרה נא לפנות למספר {user.phone}</span>
              </p>
            )}
            <div className="flex gap-2 justify-end">
              ...
              <button
                disabled={!soldier.mobile_phone || !whatsappMessage.trim()}
                onClick={() => {
        ...
        <div className="flex-1 bg-gray-900 rounded-xl border border-gray-700 p-5 min-w-0">
          <div className="flex justify-between items-center mb-5">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={() => { setWhatsappMessage(''); setWhatsappOpen(true); }}
                title="שלח WhatsApp"
