...
export const BattalionImportPage: React.FC = () => {
  ...
  const KNOWN_COLUMNS = [
    'מספר אישי','שם משפחה','שם פרטי','טלפון נייד','דרגה','פלוגה','מחלקה',
    'סטודנט 2026','מסופח','סטוס פנייה','מצב משפחתי','מספר ילדים',
  ...
  return (
    <div className="p-6 max-w-xl mx-auto" dir="rtl">
        ...
        {/* Known columns info */}
        <div className="mt-6 bg-blue-900/40 border border-blue-700 rounded-lg p-4 text-sm text-blue-300" dir="rtl">
