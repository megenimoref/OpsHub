...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    subcategories: [
      ...
      { key: 'income_loss',      label: 'אובדן הכנסה חייל',           keywords: ['אובדן הכנסה', 'איבוד הכנסה', 'הפסד הכנסה'] },
      { key: 'unpaid_leave',     label: 'חל"ת',                      keywords: ['חל"ת', 'חלת', 'חופשה ללא תשלום'] },
      { key: 'dismissal_protection', label: 'הגנה מפני פיטורין',     keywords: ['פיטורין', 'פיטורים', 'הגנה מפני פיטור', 'לא לפטר'] },
    ],
  },
  {
    key: 'self_employed',
  ...
  },
  {
    ...
    color: 'rose',
    subcategories: [
      { key: 'welfare_fund',     label: 'קרן הסיוע / מענקים',         keywords: [
          // קרן הסיוע
  ...
  },
  {
    ...
    color: 'violet',
    subcategories: [
      { key: 'emotional_therapy',label: 'טיפול רגשי',                 keywords: [
