...
export const CATEGORIES: Category[] = [
  {
    ...
    subcategories: [
      ...
      { key: 'fighter_card',     label: 'כרטיס / ארנק דיגיטלי פייטר', keywords: ['פייטר', 'כרטיס דיגיטלי', 'fighter', 'ארנק דיגיטלי', 'ארנק', 'להנפיק'] },
      { key: 'vacation_voucher', label: 'שובר חופשה',               keywords: ['שובר חופשה', 'שוברי חופשה', 'שובר החופש', 'שובר חופש'] },
      { key: 'professional_fix', label: 'איש מקצוע / תקלות בית',    keywords: ['איש מקצוע', 'תיקון', 'תיקונים', 'בעל מקצוע', 'תקלות בית', 'תקלה בבית', 'תקלות'] },
  ...
  },
  {
    ...
    subcategories: [
      { key: 'employer_issues',  label: 'בעיות מול המעסיק',          keywords: [
          ...
          'עבודה ומילואים', 'עבודה +מילואים', 'במקביל לעבודה',
          'שכר מינימום', 'מתמחה', 'התמחות',
        ] },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { key: 'tax_authority',    label: 'מס הכנסה / נקודות זיכוי',    keywords: [
          'מס הכנסה', 'נזק עקיף', 'מע"מ',
          'נקודות זיכוי', 'נק\' זיכוי', 'זיכוי במס', 'נקודת זיכוי',
        ] },
  ...
  },
  {
    ...
    subcategories: [
      { key: 'welfare_fund',     label: 'קרן הסיוע / מיצוי זכויות',   keywords: [
          // מיצוי זכויות
          'מיצוי זכויות', 'מיצוי',
          'הוזמן להסתייע', 'הוזמנה להסתייע', 'להסתייע בנו',
          'זכאות להשתתפות', 'לברר זכאות',
          'אתר המילואים', 'הפניתי לאתר', 'הפנתי לאתר',
          'כלל הזכויות', 'הסבר על כלל הזכויות', 'כלל הזכויות והמענקים',
          'עברנו על הזכויות', 'עברנו על הזכאות',
          // קרן הסיוע
          'קרן הסיוע', 'קרן סיוע', 'זכאות', 'זכאויות',
          'הגשת בקשה לקרן', 'הגשה לקרן', 'זכאות בקרן',
          'הגישה לקרן', 'הגיש לקרן', 'הגיש בקשות לקרן',
          'קישורים רלוונטיים', 'קישורים', 'שלח קישורים',
          'קיבל הסבר', 'קיבלה הסבר',
          'הסבר על', 'הוסבר לו', 'הוסבר לה', 'הסברתי',
          // מענקים / מענים
          'מענק', 'מענקים', 'מענים', 'המענים השונים',
          'כלל המענקים', 'מענקים והזכויות',
          'הסבר על כלל המענקים', 'מענק מפקדים',
          'מענק למשרת', 'מענק משרת', 'משרת שאינו עובד',
          'מענק למי שאינו עובד', 'מי שאינו עובד',
          'הכרתי לו את המענים', 'הכרתי את המענים',
  ...
  },
  {
    ...
    subcategories: [
      { key: 'emotional_therapy',label: 'טיפול רגשי / סיוע נפשי',     keywords: [
          ...
          'מענים רגשיים', 'חושש', 'פחד', 'קשיים רגשיים',
        ] },
      ...
      { key: 'therapy_funding',  label: 'מימון / החזר טיפולים',        keywords: [
          ...
          'ניצול טיפול', 'טיפול בגין שנים', 'שנים קודמות',
          'תוקף טיפולים', 'כיצד להגיש', 'הגשת טיפולים',
        ] },
    ],
  },
  {
  ...
  },
  {
    ...
    subcategories: [
      ...
      { key: 'student_grants',   label: 'מענקים / החזר לימודים',       keywords: [
          'מענק לסטודנט', 'מענק סטודנט', 'מימון לימודים',
          'קרן הסיוע לסטודנטים', 'מענקי סטודנטים', 'מענק סטודנטים',
          'החזר על הלימודים', 'החזר לימודים', 'קורס עזר',
          'בקשה לקורס', 'שכר הלימוד', 'זכאות לשכר הלימוד',
          'החזר לעצמאיים', 'עברנו על הזכאות לשכר הלימוד',
        ] },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { key: 'retiree',          label: 'גמלאי',                       keywords: ['גמלאי', 'גמלאים', 'פנסיה', 'גמלה'] },
    ],
  },
  {
    key: 'extended',
