...
export const CATEGORIES: Category[] = [
  {
    ...
    subcategories: [
      ...
      { key: 'grant_special',    label: 'מענק מיוחד',               keywords: ['מענק מיוחד'] },
      { key: 'aid_general',      label: 'סיוע כלכלי כללי',          keywords: ['סיוע כלכלי', 'עזרה כלכלית', 'מצוקה כלכלית'] },
      ...
      { key: 'damage_property',  label: 'נזק לרכוש/בית (שאגת הארי)', keywords: ['נזק לרכוש', 'נזק לבית', 'נזק רכוש', 'תיקון נזק'] },
      ...
      { key: 'pet_care',         label: 'פנסיון לבעלי חיים / דוגיסיטר', keywords: ['פנסיון', 'בעלי חיים', 'דוגיסיטר', 'דוג סיטר', 'כלב', 'חתול'] },
      { key: 'flights_vacation', label: 'החזר טיסות וחופשה',         keywords: ['החזר טיסות', 'טיסה', 'טיסות', 'חופשה בחו', 'חופשה לחו'] },
    ],
  },
  {
    key: 'employment',
    ...
    color: 'sky',
    subcategories: [
      { key: 'employer_issues',  label: 'בעיות מול המעסיק',          keywords: ['מול המעסיק', 'בעיה עם המעסיק', 'מעסיק', 'מעביד'] },
      { key: 'social_security',  label: 'בעיות מול ביטוח לאומי',      keywords: ['ביטוח לאומי', 'בלל', 'בט"ל'] },
      { key: 'reserve_payroll',  label: 'תגמולי מילואים נמוכים מהתלושים', keywords: ['תגמולי מילואים', 'תלוש', 'תלושים', 'תשלום מילואים', 'תגמול נמוך'] },
      { key: 'late_payment',     label: 'אי תשלום במועד / עיכוב',     keywords: ['אי תשלום', 'עיכוב תשלום', 'לא שילמו', 'איחור בתשלום'] },
      { key: 'income_loss',      label: 'אובדן הכנסה חייל',           keywords: ['אובדן הכנסה', 'איבוד הכנסה'] },
      { key: 'unpaid_leave',     label: 'חל"ת',                      keywords: ['חל"ת', 'חלת', 'חופשה ללא תשלום'] },
      { key: 'dismissal_protection', label: 'הגנה מפני פיטורין',     keywords: ['פיטורין', 'פיטורים', 'הגנה מפני פיטור'] },
    ],
  },
  {
    key: 'self_employed',
    ...
    subcategories: [
      ...
      { key: 'aid_fund_business',label: 'קרן סיוע — השלמות לעסקים',   keywords: ['קרן סיוע', 'השלמה לעסק', 'השלמות לעסקים'] },
      { key: 'self_employed_ni', label: 'תגמולי מילואים עצמאי',        keywords: ['מילואים עצמאי', 'תגמולי עצמאי'] },
  ...
  },
  {
    ...
    color: 'rose',
    subcategories: [
      { key: 'babysitter',       label: 'בייביסיטר',                  keywords: ['בייביסיטר', 'בייבי סיטר', 'baby sitter', 'מטפלת'] },
      { key: 'summer_camp',      label: 'קייטנות',                    keywords: ['קייטנה', 'קייטנות'] },
      { key: 'spouse_income_loss', label: 'אובדן הכנסה בת/בן זוג',    keywords: ['אובדן הכנסה בת', 'אובדן הכנסה בן', 'הכנסת בן זוג', 'הכנסת בת זוג'] },
      { key: 'spouse_dismissal', label: 'הגנה מפני פיטורין אשת חייל', keywords: ['פיטורין אשת', 'פיטורים אשת', 'הגנה אשת חייל'] },
      { key: 'maternity',        label: 'חל"ד / מענק לידה',           keywords: ['חל"ד', 'חלד', 'חופשת לידה', 'מענק לידה', 'לאחר לידה'] },
      { key: 'leave_hours',      label: 'ימי ושעות היעדרות',          keywords: ['ימי היעדרות', 'שעות היעדרות', 'היעדרות מהעבודה'] },
      { key: 'divorced',         label: 'גרושים/ות (חליף משמורת)',     keywords: ['גרוש', 'גרושה', 'משמורת', 'הורות משותפת', 'חליף משמורת'] },
      { key: 'reserve_wives',    label: 'נשות מילואים',                keywords: ['נשות מילואים', 'אשת מילואים', 'אישת מילואים'] },
    ],
  },
  {
    key: 'mental',
    ...
    color: 'violet',
    subcategories: [
      { key: 'emotional_therapy',label: 'טיפול רגשי',                 keywords: ['טיפול רגשי', 'פסיכולוג', 'מטפל רגשי', 'טראומה'] },
      { key: 'couple_therapy',   label: 'טיפול זוגי',                 keywords: ['טיפול זוגי', 'יעוץ זוגי', 'מטפל זוגי'] },
      { key: 'family_therapy',   label: 'טיפול משפחתי',                keywords: ['טיפול משפחתי', 'מטפל משפחתי', 'יעוץ משפחתי'] },
      { key: 'therapy_funding',  label: 'מימון / החזר טיפולים',        keywords: ['החזר טיפולים', 'עמית', 'מימון טיפול', 'תוכנית עמית'] },
    ],
  },
  {
    key: 'legal',
    ...
    color: 'slate',
    subcategories: [
      { key: 'legal_general',    label: 'ייעוץ משפטי כללי',           keywords: ['ייעוץ משפטי', 'עורך דין', 'עו"ד', 'משפטן'] },
      { key: 'legal_employer',   label: 'ליווי משפטי מול המעסיק',      keywords: ['משפטי מול המעסיק', 'תביעה מעסיק'] },
      { key: 'legal_govt',       label: 'ליווי מול גופים ממשלתיים',    keywords: ['גוף ממשלתי', 'משרד ממשלתי', 'מול הרשויות', 'מול המדינה'] },
    ],
  },
  {
    key: 'students',
    ...
    subcategories: [
      ...
      { key: 'student_grants',   label: 'מענקים לסטודנטים',           keywords: ['מענק לסטודנט', 'מענק סטודנט', 'מימון לימודים'] },
      { key: 'mimadim',          label: 'ממדים ללימודים',             keywords: ['ממדים ללימודים', 'ממד"ים', 'ממדים'] },
      { key: 'academic_adjust',  label: 'התאמות אקדמיות',             keywords: ['התאמות אקדמיות', 'התאמה אקדמית'] },
      { key: 'institution_contact', label: 'קשר מול מוסד הלימודים',   keywords: ['מוסד הלימודים', 'אוניברסיטה', 'מכללה', 'בית ספר גבוה'] },
    ],
  },
  {
    key: 'special_pop',
    ...
    color: 'fuchsia',
    subcategories: [
      { key: 'lone_soldier',     label: 'חייל בודד',                   keywords: ['חייל בודד', 'בודד'] },
      { key: 'abroad',           label: 'מרכז חיים בחו"ל',             keywords: ['חו"ל', 'בחול', 'מרכז חיים בחו', 'תושב חוץ'] },
    ],
  },
  {
    key: 'extended',
    ...
    color: 'orange',
    subcategories: [
      { key: 'reserve_injury',   label: 'פציעות גוף במילואים',         keywords: ['פציעה במילואים', 'פציעת גוף', 'נפצע'] },
      { key: 'rehab_dept',       label: 'אגף השיקום',                   keywords: ['אגף השיקום', 'שיקום נכים', 'שיקום צה"ל'] },
      { key: 'medical_committee',label: 'ועדות רפואיות',                keywords: ['ועדה רפואית', 'ועדות רפואיות', 'ועדה רפואית בצה"ל'] },
      { key: 'mortgage',         label: 'הקלות במשכנתא',                keywords: ['משכנתא', 'הקלה במשכנתא', 'דחיית משכנתא'] },
      { key: 'rent_landlord',    label: 'בעיות מול משכירים',            keywords: ['משכיר', 'בעל הדירה', 'משכירים'] },
      { key: 'rent_payment',     label: 'קשיים בתשלום שכ"ד',           keywords: ['שכר דירה', 'שכ"ד', 'שכד'] },
      ...
      { key: 'school_issues',    label: 'בעיות בבתי ספר',                keywords: ['בית ספר', 'בית הספר', 'בית"ס', 'בית-ספר'] },
      { key: 'tutoring_kids',    label: 'תגבור לימודי לילדים',           keywords: ['תגבור לימודי', 'תגבור לימודים', 'מורה לילד'] },
      { key: 'digital_literacy', label: 'אוריינות דיגיטלית',             keywords: ['אוריינות דיגיטלית', 'הגשת טפסים', 'מילוי טפסים', 'מילוי באתר'] },
      { key: 'release_workshop', label: 'סדנאות שחרור / קהילה',          keywords: ['סדנת שחרור', 'סדנאות שחרור', 'קהילה', 'יום עיבוד'] },
    ],
  },
];
