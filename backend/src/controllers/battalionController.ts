...
// ─── Sync Excel → DB ───────────────────────────────────────────────────────
// For every soldier that exists in BOTH the DB and the Excel, update
// first_name / last_name / mobile_phone in the DB to match the Excel value.
